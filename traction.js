...
(function() {
  ...
  Traction.Rendering.AppendStrategy = (function(_super) {
    ...
    function AppendStrategy() {
      _ref = AppendStrategy.__super__.constructor.apply(this, arguments);
      return _ref;
    }
...
(function() {
  ...
  Traction.Rails.Model = (function(_super) {
    ...
    Model.prototype.parseErrors = function(self, response) {
      var _ref1;
      return this.errors = (_ref1 = $.parseJSON(response.responseText)) != null ? _ref1.errors : void 0;
    };
    ...
    Model.prototype.toJSON = function() {
      var attribute, json, _i, _len, _ref1;
      if (this.persists) {
        json = {};
        _ref1 = this.persists;
    ...
    Model.prototype._setAssociations = function(attributes, options) {
      var associationName, isDirty, klass, newValue, previousValue, urlRoot, _ref1, _results;
      _ref1 = this.associations;
      _results = [];
      for (associationName in _ref1) {
        klass = _ref1[associationName];
...
(function() {
  ...
  Traction.Forms.TextField = (function(_super) {
    ...
    function TextField() {
      _ref = TextField.__super__.constructor.apply(this, arguments);
      return _ref;
    }
