  ...
  describe("Traction.Forms.TextField", function() {
    ...
    describe("#render", function() {
      ...
      it("renders an input with the correct name", function() {
        ...
        field = createInstance();
        field.render();
        return expect(field.$("input").attr("name")).toBe("first_name_input");
      });
      it("renders an input with the correct type", function() {
        var field;
        field = createInstance().render();
      ...
      it("renders an input with the correct placeholder", function() {
        var field;
        field = createInstance().render();
        return expect(field.$("input").attr("placeholder")).toBe("First name");
      });
      it("allows the placeholder to be specified", function() {
        ...
        return expect(field.$("input").attr("placeholder")).toBe("alternative placeholder");
      });
      it("initializes the input content", function() {
        ...
        return expect(field.$("input").val()).toBe("Jobin");
      });
    ...
    describe("#set", function() {
      return it("sets the input value", function() {
        ...
        field = createInstance().render();
        field.set("ABC");
        return expect(field.$("input").val()).toBe("ABC");
      });
    });
